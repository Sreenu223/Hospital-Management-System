...
import random as rd
con=sqlcon.connect(host="127.0.0.1",user="root",password="Sreenu@1234")#connection to mysql 
cur=con.cursor()
...
def lst_doc():
    ...
    l=["T. Sreenivasulu Reddy","Varshini","litvik","Mohan","Chandu","Yogananda","Karthik","Purna","Sundar","Harsha",'zameer','sameer',
       'mohan','Guna']
...
def ser_avail():
    ...
    l5=Label(root5,text='To avail any of these please contact on our no.:- 9488743479')
    l5.place(x=20,y=240)
...
root=Tk()
label=Label(root,text="SREENU HOSPITAL",font="arial 40 bold",bg='light blue')
b1=Button(text="Registration",font="arial 20 bold",bg='green',command=register)
b2=Button(text="Appointment",font="arial 20 bold",bg='purple',command=apoint)
b3=Button(text="List of Doctors",font="arial 20 bold",bg='yellow',command=lst_doc)
b4=Button(text="Services available",font='arial 20 bold',bg='orange',command=ser_avail)
